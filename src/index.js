...
import "./components/video/video-slider";
import "./components/video/custom-player";

import "./components/header/header";
import "./components/explore/explore-slider";
import "./components/welcome/welocome-slider";
...
console.log(`
  ...
  10. Любой собственный дополнительный функционал: добавлена возможность лайкнуть понравившуюся картину. Данные сохраняются в localStorage +10
  Итого: 150 баллов
`);
